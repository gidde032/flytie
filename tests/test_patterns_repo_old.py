...
These exercise create/get/list/search and the versioning bump on edit, which
all sit underneath the CLI commands implemented in later phases.
"""
...
def test_edit_pattern_creates_new_version_preserving_old(session) -> None:  # type: ignore[no-untyped-def]
    ...
    # Version 1 still exists with its original materials.
